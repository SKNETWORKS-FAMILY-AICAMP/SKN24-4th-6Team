...
from accounts.serializers import validate_nickname_format, validate_password_format
  ...
  def validate(self, attrs):
    ...
    if attrs.get("password"):
      if not attrs.get("password_confirm"):
        raise serializers.ValidationError({"password_confirm": "새 비밀번호 확인을 입력해주세요."})
